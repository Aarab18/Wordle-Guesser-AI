document.addEventListener('DOMContentLoaded', () => {
	const wordList = [
		...
		"swirl", "swish", "swoon", "swoop", "sword", "swore", "sworn", "swung", "synod", "syrup", "tabby", "table", "taboo", "tacit", "tacky", "taffy", "taint", "taken", "taker", "tally",
	...
	howToPlayButton.addEventListener('click', () => {
		...
		howToPlayModal.classList.add('opacity-100', 'pointer-events-auto');
		howToPlayButton.classList.add('hidden');
	});
	closeModalButton.addEventListener('click', () => {
		howToPlayModal.classList.add('opacity-0', 'pointer-events-none');
		howToPlayModal.classList.remove('opacity-100', 'pointer-events-auto');
	...
	if (!localStorage.getItem('wordleAIHasPlayed')) {
		howToPlayModal.classList.remove('opacity-0', 'pointer-events-none');
		howToPlayModal.classList.add('opacity-100', 'pointer-events-auto');
		howToPlayButton.classList.add('hidden');
		localStorage.setItem('wordleAIHasPlayed', 'true');
	}
	startGame();
});
